					...
					<div className="col-lg-5 mb-4 col-md-4 col-xl-3">
						<div className="profile-card d-flex flex-column align-items-center text-center">
							<div className="position-relative">
								<input onChange={event=>handleChange(event)} type="file" id="pic_upload" hidden />
						...
						<div className="list-group">
						  ...
						  <Link to="/" className="list-group-item active list-group-item-action"><i className="fas fa-lock"></i> Change Password</Link>
						  <Link to="/" className="list-group-item list-group-item-action"><i className="fas fa-user"></i> Complete Profile</Link>
						</div>
					</div>
									...
									<div className="row">
										<div className="form-group mb-md-4 mb-3 col-sm-6">
											<div className="form-field">
												...
												<input onChange={event=>handleChange(event)} type="password" className="form-control" value="Enter Old Password" />
											</div>
										</div>
										<div className="form-group mb-md-4 mb-3 col-sm-6">
											<div className="form-field">
												<label>Enter New Password</label>
												<input type="password" onChange={event=>handleChange(event)} className="form-control" value="Enter New Password" />
											</div>
										</div>
										<div className="form-group mb-md-4 mb-3 col-sm-6">
											<div className="form-field">
												<label>Confirm New Password</label>
												<input type="password" onChange={event=>handleChange(event)} className="form-control" value="Confirm New Password" />
											</div>
										</div>
